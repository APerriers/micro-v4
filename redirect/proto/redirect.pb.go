...
func (x *ClientStreamRequest) Reset() {
	*x = ClientStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ClientStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{2}
}
...
func (x *ClientStreamResponse) Reset() {
	*x = ClientStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ClientStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{3}
}
...
func (x *ServerStreamRequest) Reset() {
	*x = ServerStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServerStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{4}
}
...
func (x *ServerStreamResponse) Reset() {
	*x = ServerStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServerStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{5}
}
...
func (x *BidiStreamRequest) Reset() {
	*x = BidiStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidiStreamRequest) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{6}
}
...
func (x *BidiStreamResponse) Reset() {
	*x = BidiStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_redirect_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BidiStreamResponse) Descriptor() ([]byte, []int) {
	return file_proto_redirect_proto_rawDescGZIP(), []int{7}
}
...
var file_proto_redirect_proto_rawDesc = []byte{
	0x0a, 0x14, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	...
	0x52, 0x06, 0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65, 0x32, 0xb8, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x64,
	0x69, 0x72, 0x65, 0x63, 0x74, 0x12, 0x37, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x15, 0x2e,
	0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71,
	...
	0x2e, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e,
	0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53,
	...
	0x6d, 0x12, 0x1d, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1e, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x53, 0x65, 0x72, 0x76,
	...
	0x61, 0x6d, 0x12, 0x1b, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x42, 0x69,
	0x64, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1c, 0x2e, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x2e, 0x42, 0x69, 0x64, 0x69, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28,
	0x01, 0x30, 0x01, 0x42, 0x12, 0x5a, 0x10, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x72,
...
var (
	...
	file_proto_redirect_proto_rawDescData = file_proto_redirect_proto_rawDesc
)

func file_proto_redirect_proto_rawDescGZIP() []byte {
	file_proto_redirect_proto_rawDescOnce.Do(func() {
		file_proto_redirect_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_redirect_proto_rawDescData)
	})
	return file_proto_redirect_proto_rawDescData
}

var file_proto_redirect_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_redirect_proto_goTypes = []interface{}{
	(*CallRequest)(nil),          // 0: redirect.CallRequest
	(*CallResponse)(nil),         // 1: redirect.CallResponse
	(*ClientStreamRequest)(nil),  // 2: redirect.ClientStreamRequest
	(*ClientStreamResponse)(nil), // 3: redirect.ClientStreamResponse
	(*ServerStreamRequest)(nil),  // 4: redirect.ServerStreamRequest
	(*ServerStreamResponse)(nil), // 5: redirect.ServerStreamResponse
	(*BidiStreamRequest)(nil),    // 6: redirect.BidiStreamRequest
	(*BidiStreamResponse)(nil),   // 7: redirect.BidiStreamResponse
}
var file_proto_redirect_proto_depIdxs = []int32{
	0, // 0: redirect.Redirect.Call:input_type -> redirect.CallRequest
	2, // 1: redirect.Redirect.ClientStream:input_type -> redirect.ClientStreamRequest
	4, // 2: redirect.Redirect.ServerStream:input_type -> redirect.ServerStreamRequest
	6, // 3: redirect.Redirect.BidiStream:input_type -> redirect.BidiStreamRequest
	1, // 4: redirect.Redirect.Call:output_type -> redirect.CallResponse
	3, // 5: redirect.Redirect.ClientStream:output_type -> redirect.ClientStreamResponse
	5, // 6: redirect.Redirect.ServerStream:output_type -> redirect.ServerStreamResponse
	7, // 7: redirect.Redirect.BidiStream:output_type -> redirect.BidiStreamResponse
...
func file_proto_redirect_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_redirect_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_redirect_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_redirect_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_redirect_proto_rawDesc = nil
