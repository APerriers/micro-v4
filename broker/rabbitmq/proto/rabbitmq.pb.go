...
var file_proto_rabbitmq_proto_rawDesc = []byte{
	0x0a, 0x14, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71,
	...
	0x52, 0x06, 0x73, 0x74, 0x72, 0x6f, 0x6b, 0x65, 0x32, 0xb8, 0x02, 0x0a, 0x08, 0x52, 0x61, 0x62,
	0x62, 0x69, 0x74, 0x6d, 0x71, 0x12, 0x37, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x15, 0x2e,
	0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e,
	...
	0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e,
	0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53,
	...
	0x6d, 0x12, 0x1d, 0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1e, 0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x53, 0x65, 0x72, 0x76,
	...
	0x61, 0x6d, 0x12, 0x1b, 0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x42, 0x69,
	0x64, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1c, 0x2e, 0x72, 0x61, 0x62, 0x62, 0x69, 0x74, 0x6d, 0x71, 0x2e, 0x42, 0x69, 0x64, 0x69, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28,
...
var (
	...
	file_proto_rabbitmq_proto_rawDescData = file_proto_rabbitmq_proto_rawDesc
)

func file_proto_rabbitmq_proto_rawDescGZIP() []byte {
	file_proto_rabbitmq_proto_rawDescOnce.Do(func() {
		file_proto_rabbitmq_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_rabbitmq_proto_rawDescData)
	})
	return file_proto_rabbitmq_proto_rawDescData
}

var file_proto_rabbitmq_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_rabbitmq_proto_goTypes = []interface{}{
	(*CallRequest)(nil),          // 0: rabbitmq.CallRequest
	(*CallResponse)(nil),         // 1: rabbitmq.CallResponse
	(*ClientStreamRequest)(nil),  // 2: rabbitmq.ClientStreamRequest
	(*ClientStreamResponse)(nil), // 3: rabbitmq.ClientStreamResponse
	(*ServerStreamRequest)(nil),  // 4: rabbitmq.ServerStreamRequest
	(*ServerStreamResponse)(nil), // 5: rabbitmq.ServerStreamResponse
	(*BidiStreamRequest)(nil),    // 6: rabbitmq.BidiStreamRequest
	(*BidiStreamResponse)(nil),   // 7: rabbitmq.BidiStreamResponse
}
var file_proto_rabbitmq_proto_depIdxs = []int32{
	0, // 0: rabbitmq.Rabbitmq.Call:input_type -> rabbitmq.CallRequest
	2, // 1: rabbitmq.Rabbitmq.ClientStream:input_type -> rabbitmq.ClientStreamRequest
	4, // 2: rabbitmq.Rabbitmq.ServerStream:input_type -> rabbitmq.ServerStreamRequest
	6, // 3: rabbitmq.Rabbitmq.BidiStream:input_type -> rabbitmq.BidiStreamRequest
	1, // 4: rabbitmq.Rabbitmq.Call:output_type -> rabbitmq.CallResponse
	3, // 5: rabbitmq.Rabbitmq.ClientStream:output_type -> rabbitmq.ClientStreamResponse
	5, // 6: rabbitmq.Rabbitmq.ServerStream:output_type -> rabbitmq.ServerStreamResponse
	7, // 7: rabbitmq.Rabbitmq.BidiStream:output_type -> rabbitmq.BidiStreamResponse
...
func file_proto_rabbitmq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_rabbitmq_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_rabbitmq_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_rabbitmq_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_rabbitmq_proto_rawDesc = nil
